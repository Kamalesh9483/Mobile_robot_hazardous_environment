...
cap = cv2.VideoCapture('http://JioFiber 1:Dexiatoungjio@192.168.29.168:81/stream')
...
while(True):
    ...
    #remove noise using threshold
        ...
        cv2.imshow("Threshed",sobelCombined)
    ...
    # plt.show()
        ...
        conts = cv2.findContours(sobelCombined, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
